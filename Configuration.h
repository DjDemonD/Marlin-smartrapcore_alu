...
//#define BED_CENTER_AT_85_85  // If defined, the center of the bed is at (X=0, Y=0)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,160,120} // default steps per unit for Ultimaker
